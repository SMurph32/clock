...
void read_enc(knob){
	...
	uint8_t temp = (enc/knob)%4, *target;//isolates 2 digits relevant to encoder
...
void segsum(uint16_t sum, int c_mode) {
	int num_d=0, i, hour, min;
	int temp, temp2, am;
	temp = sum;
